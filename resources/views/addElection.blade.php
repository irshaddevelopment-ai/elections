...
@section('content')
    ...
    <style>
        body {
    font-size: 18px; /* Set your desired default font size */
}
    ...
    <div class="container" dir="rtl">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                <div class="card-header" style="text-align:center;">إضافة عملية انتخابية فردية</div>
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" id="input_election_code" name="input_election_code" class="form-control"
                            ...
                            <div class="md-form">
                                ...
                                <input type="text" id="input_election_name" name="input_election_name" class="form-control"
                                    autocomplete="off">
                            </div>
                            ...
                            <div class="md-form">
                                ...
                                <input type="date" id="input_election_date" name="input_election_date" class="form-control">

                            </div>
                            <div class="form-check form-switch">
  <input class="form-check-input" type="checkbox" id="input_election_status" name="input_election_status" checked>
...
<div class="container">
    ...
    <script>
        ...
        function moveChooseUserToChoosen(clickedElement) {
            ...
            var nameValue = row_selected.find('th:eq(1)').text();
            if (isChecked == true) {
                $('#choosen_users').append(
                    '<tr id=' + rownumber + '><th><input type="text" name="choosen_candidate[]" value="' + nameValue + '" readonly/></th></tr>'
                );
            } else {
                $('#' + rownumber + '').remove();
            }
            ...
            .then(response => {
                ...
                for (let i = 0; i < result_data.length; i++) {
                    $('#choose_users').append(
                        ...
                        i + '" onclick="moveChooseUserToChoosen(this)"></div></th><th>' +
