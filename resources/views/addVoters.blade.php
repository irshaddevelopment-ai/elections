        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card d-grid gap-3">
                    <div class="card-header p-2" style="text-align:center;">إضافة ناخبين</div>
                    ...
                    <div class="card-body ">
                        ...
                        <form id="user_info_form" action="/savevoters" method="post">
                            @csrf
                            <!-- {{ csrf_field() }} -->
                            ...
                            <!-- First Text Field -->
                            <div class="md-form">
                            <label for="dateField">العملية الانتخابية</label>
